...
<head>
    <meta charset="UTF-8">
    <title>Gestionare Studenți</title>
    <style>
        ...
        nav a { color:#e5e7eb; text-decoration:none; margin-right:12px; }
        ...
        .btn { display:inline-block; padding:6px 12px; border-radius:6px; border:none;
               background:#0ea5e9; color:white; text-decoration:none; cursor:pointer; font-size:0.9rem; }
...
<header>
    <div style="display:flex;align-items:center;justify-content:space-between;">
        <h1>Gestionare Studenți (PHP + PDO)</h1>
        <nav>
            <a href="listare.php">Listare studenți</a>
            <a href="adauga_with_upload.php">Adaugă student</a>
			<a href="editeaza.php">Editeaza student</a>
			<?php if (isset($_SESSION['user_id'])): ?>
                <span style="margin-left:16px;color:#e5e7eb;">
                    Logat ca: <strong><?php echo htmlspecialchars($_SESSION['username'], ENT_QUOTES, 'UTF-8'); ?></strong>
                    (<?php echo htmlspecialchars($_SESSION['rol'], ENT_QUOTES, 'UTF-8'); ?>)
                </span>
            <a class="btn" href="logout.php" style="margin-left:8px;">Logout</a>
            <?php else: ?>
